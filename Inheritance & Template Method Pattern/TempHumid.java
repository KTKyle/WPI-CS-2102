 ...
 * would be a stream for the date April 1st, 2024 with temperatures 72F and 73F
 and humidity %s 10% and 11%
 */
public interface TempHumid {
    ...
    /**
     * Loads a stream of temperature humidity data into memory (stores it in a
     field)
     * @param data
